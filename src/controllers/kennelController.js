import Kennel from '../models/Kennel.js';
...
export const getKennels = async (req, res, next) => {
  try {
...
export const createKennel = async (req, res, next) => {
  try {
...
export const updateKennel = async (req, res, next) => {
  try {
...
export const deleteKennel = async (req, res, next) => {
  try {
